...
script =
    [
        ...
        Configure "pfq-haskell-lib" *>>  into "user/Haskell/" [ cabalConfigureUser ] .|. [ Install "pfq.ko", Install "pfq-clib" ],
...
--      Configure "pfq-pcap"        *>>  into "user/libpcap/libpcap-1.3.0/" [ "./configure --enable-pfq" ] .|. [ Install "pfq.ko", Install "pfq-clib" ],
--      Build     "pfq-pcap"        *>>  into "user/libpcap/libpcap-1.3.0/" [ make ]           .|. [ Configure "pfq-pcap" ],
--      Install   "pfq-pcap"        *>>  into "user/libpcap/libpcap-1.3.0/" [  ]               .|. [ Build "pfq-pcap" ],
--      Clean     "pfq-pcap"        *>>  into "user/libpcap/libpcap-1.3.0/" [ make_clean ],

        Configure "pfq-hcounters"   *>>  into "user/Haskell/pfq-hcounters/" [ cabalConfigureUser ] .|. [ Install   "pfq-haskell-lib" ],
        ...
        Configure "pfq-htest"       *>>  into "user/Haskell/pfq-htest/" [ cabalConfigureUser ] .|. [ Install   "pfq-haskell-lib" ],
        ...
        Configure "irq-affinity"    *>>  into "user/irq-affinity/" [ cabalConfigureUser ] .|. [ Install   "pfq-haskell-lib" ],
        ...
        Configure "pfq-omatic"      *>>  into "user/pfq-omatic/" [ cabalConfigureUser ] .|. [ Install   "pfq-haskell-lib" ],
        ...
        Configure "pfq-load"        *>>  into "user/pfq-load/"   [ cabalConfigureUser ] .|. [ Install   "irq-affinity" ],
        ...
        Configure "pfq-stress"      *>>  into "user/pfq-stress/" [ cabalConfigureUser ] .|. [ Install   "irq-affinity", Install "pfq-load" ],
        ...
        Configure "pfqd"            *>>  into "user/pfqd/" [ cabalConfigureUser ] .|. [ Install   "pfq-haskell-lib", Install "pfq.ko" ],
