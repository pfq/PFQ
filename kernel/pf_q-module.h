...
#define get_arg_4(type,a) 	__builtin_choose_expr(sizeof(type) <= sizeof(uint64_t), *(type *)&ARGS_TYPE(a)->arg[4], (void *)ARGS_TYPE(a)->arg[4].value)
#define get_arg_5(type,a) 	__builtin_choose_expr(sizeof(type) <= sizeof(uint64_t), *(type *)&ARGS_TYPE(a)->arg[5], (void *)ARGS_TYPE(a)->arg[5].value)
#define get_arg_6(type,a) 	__builtin_choose_expr(sizeof(type) <= sizeof(uint64_t), *(type *)&ARGS_TYPE(a)->arg[6], (void *)ARGS_TYPE(a)->arg[6].value)
#define get_arg_7(type,a) 	__builtin_choose_expr(sizeof(type) <= sizeof(uint64_t), *(type *)&ARGS_TYPE(a)->arg[7], (void *)ARGS_TYPE(a)->arg[7].value)
...
#define get_array_len_4(a) 	(ARGS_TYPE(a)->arg[4].nelem)
#define get_array_len_5(a) 	(ARGS_TYPE(a)->arg[5].nelem)
#define get_array_len_6(a) 	(ARGS_TYPE(a)->arg[6].nelem)
#define get_array_len_7(a) 	(ARGS_TYPE(a)->arg[7].nelem)
