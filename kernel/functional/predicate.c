...
struct pfq_predicate_fun_descr predicate_functions[] = {
        ...
        { "is_l3_proto", __is_l3_proto 	, FUN_PREDICATE | FUN_WITH_ARG },
        { "is_l4_proto", __is_l4_proto	, FUN_PREDICATE | FUN_WITH_ARG },
        { "has_port",    __has_port     , FUN_PREDICATE | FUN_WITH_ARG },
        { "has_src_port",__has_src_port , FUN_PREDICATE | FUN_WITH_ARG },
