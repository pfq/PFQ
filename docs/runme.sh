...
cd ../user/Haskell && runhaskell Setup configure --user && runhaskell Setup build && haddock -h -o ../../docs/api/haskell  -t "PFQ Library v4.0" -p ../../docs/library.haddock dist/build/Network/PFq.hs
cd -
