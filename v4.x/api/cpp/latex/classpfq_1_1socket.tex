...
void \hyperlink{classpfq_1_1socket_a0efc7c8cb3f3b52d2db3f0b5d3351ac2}{tx\+\_\+async} (bool value)
\begin{DoxyCompactList}\small\item\em Start/\+Stop kernel threads. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
The first argument is the name of the device; the second argument is the queue number or any\+\_\+queue. \hypertarget{classpfq_1_1socket_ae1a9ad5e1d5ad478a1a642f29f49e9c0}{\index{pfq\+::socket@{pfq\+::socket}!bind\+\_\+tx@{bind\+\_\+tx}}
...
A socket can be bound up to a maximum number of queues. The core parameter specifies the C\+P\+U index where to run a kernel thread (unless no\+\_\+kthread id is specified). \hypertarget{classpfq_1_1socket_ab68dbba5ef01041b9c96758c4a9f0a6c}{\index{pfq\+::socket@{pfq\+::socket}!caplen@{caplen}}
...
The function takes an instance of a callable type. The object must have the following callable signature\+:
...
\hypertarget{classpfq_1_1socket_a66ce6d24cf127796ba26fe3112b82f44}{\index{pfq\+::socket@{pfq\+::socket}!inject@{inject}}
...
Wait for packets and return a queue descriptor. Packets are stored in the memory mapped queue of the socket. The timeout is specified in microseconds. \hypertarget{classpfq_1_1socket_ace69fbf64216b7b30a8a305a9d25229b}{\index{pfq\+::socket@{pfq\+::socket}!recv@{recv}}
...
The number of Rx slots can't exceed the value specified by the max\+\_\+queue\+\_\+slot kernel module parameter. \hypertarget{classpfq_1_1socket_a0f2205329249eaa7a6229980a744fd2a}{\index{pfq\+::socket@{pfq\+::socket}!rx\+\_\+slots@{rx\+\_\+slots}}
\index{rx\+\_\+slots@{rx\+\_\+slots}!pfq\+::socket@{pfq\+::socket}}
...
The queue is flushed (if required) and the transmission takes place. \hypertarget{classpfq_1_1socket_aa3429cc82396d2bd30a55876c6fff8ba}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+async@{send\+\_\+async}}
...
\begin{DoxyParamCaption}
\item[{{\bf const\+\_\+buffer}}]{pkt, }
\item[{size\+\_\+t}]{flush\+\_\+hint = {\ttfamily 1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_aa3429cc82396d2bd30a55876c6fff8ba}


Store the packet and transmit the packets in the queue, asynchronously. 

The transmission is invoked every  packets. When kernel threads are in use,  is ignored. \hypertarget{classpfq_1_1socket_a0898dc7fd64a260c2e4104bff0314020}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+at@{send\+\_\+at}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a0898dc7fd64a260c2e4104bff0314020}
Store the packet and transmit it.

The transmission takes place at the given timespec time, specified as a generic chrono\+::time\+\_\+point. \hypertarget{classpfq_1_1socket_a5cb37765ffcb1b78c5d61211f9e806df}{\index{pfq\+::socket@{pfq\+::socket}!set\+\_\+group\+\_\+computation@{set\+\_\+group\+\_\+computation}}
...
This function is limited to simple P\+F\+Q/lang functional computations. Only the composition of monadic functions without arguments are supported. \hypertarget{classpfq_1_1socket_ad618894910a12a08eaed3d8668db25af}{\index{pfq\+::socket@{pfq\+::socket}!set\+\_\+group\+\_\+fprog@{set\+\_\+group\+\_\+fprog}}
...
\hypertarget{classpfq_1_1socket_a0efc7c8cb3f3b52d2db3f0b5d3351ac2}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+async@{tx\+\_\+async}}
\index{tx\+\_\+async@{tx\+\_\+async}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{tx\+\_\+async}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::tx\+\_\+async (
\begin{DoxyParamCaption}
\item[{bool}]{value}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a0efc7c8cb3f3b52d2db3f0b5d3351ac2}


Start/\+Stop kernel threads. 

Start/\+Stop kernel threads associated with Tx queues. \hypertarget{classpfq_1_1socket_a88e4764d8e7fc86b6e3ea1fbff407a96}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+queue\+\_\+flush@{tx\+\_\+queue\+\_\+flush}}
...
The number of Tx slots can't exceed the value specified by the max\+\_\+queue\+\_\+slot kernel module parameter. \hypertarget{classpfq_1_1socket_a11b91a39fdae65cace365aa3583eba7d}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+slots@{tx\+\_\+slots}}
\index{tx\+\_\+slots@{tx\+\_\+slots}!pfq\+::socket@{pfq\+::socket}}
