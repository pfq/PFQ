...
Monadic version of 'has\+\_\+addr' predicate. 

Predicates are used in conditional expressions, while monadic functions are combined with kleisli operator\+:

addr (\char`\"{}192.\+168.\+0.\+0\char`\"{},24) $>$-\/$>$ log\+\_\+packet \hypertarget{namespacepfq_1_1lang_1_1anonymous__namespace_02default_8hpp_03_abfcd230137acb93cfd99f7a0a7c1f17f}{\index{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}@{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}}!bloom@{bloom}}
...
\hyperlink{structpfq_1_1lang_1_1Predicate}{Predicate} that evaluates to /\+True/ when the source or the destination address. 

The first 'C\+Int' argument specifies the size of the bloom filter. Example\+:
...
Monadic counterpart of 'bloom\+\_\+dst' function. 
...
Monadic counterpart of 'bloom\+\_\+src' function. 
...
Monadic version of 'has\+\_\+src\+\_\+addr' predicate. 
...
Monadic version of 'has\+\_\+dst\+\_\+port' predicate. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is a T\+C\+P or U\+D\+P packet, /\+Drop/ it otherwise. 
...
Evaluate to /\+True/ if the source or destination I\+P address matches the given network address. I.\+e.,. 
...
Evaluate to /\+True/ if the destination I\+P address matches the given network address. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has the given destination port. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has the given mark, set by 'mark' function. 

Example\+:

has\+\_\+mark(11) \hypertarget{namespacepfq_1_1lang_1_1anonymous__namespace_02default_8hpp_03_a9f7161b8dfb842c5a845f413eb6bc82f}{\index{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}@{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}}!has\+\_\+port@{has\+\_\+port}}
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has the given source or destination port. 
...
Evaluate to /\+True/ if the source I\+P address matches the given network address. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has the given source port. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has the given vlan id. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has a vlan tag. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is an I\+C\+M\+P packet, /\+Drop/ it otherwise. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is an I\+C\+M\+P packet (on top of I\+Pv6), /\+Drop/ it otherwise. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is an I\+Pv4 packet, /\+Drop/ it otherwise. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is an I\+Pv6 packet, /\+Drop/ it otherwise. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is the first T\+C\+P fragment. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is an U\+D\+P or T\+C\+P packet. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is a T\+C\+P fragment. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is an I\+C\+M\+P packet. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is an I\+C\+M\+P packet, on top of I\+Pv6. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is an I\+Pv4 packet. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is an I\+Pv6 packet. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has the given Layer3 protocol. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} has the given Layer4 protocol. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is a T\+C\+P fragment, but the first. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is a T\+C\+P packet. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is a T\+C\+P packet, on top of I\+Pv6. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is an U\+D\+P packet. 
...
Evaluate to /\+True/ if the \hyperlink{structpfq_1_1lang_1_1SkBuff}{Sk\+Buff} is an U\+D\+P packet, on top of I\+Pv6. 
...
Monadic version of 'is\+\_\+l3\+\_\+proto' predicate. 

Predicates are used in conditional expressions, while monadic functions are combined with Kleisli operator\+:

l3\+\_\+proto (0x842) $>$$>$ log\+\_\+msg (\char`\"{}\+Wake-\/on-\/\+L\+A\+N packet!\char`\"{}) \hypertarget{namespacepfq_1_1lang_1_1anonymous__namespace_02default_8hpp_03_a8ad2208c91dc3cd4378e715aab5fb4b7}{\index{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}@{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}}!l4\+\_\+proto@{l4\+\_\+proto}}
...
Monadic version of 'is\+\_\+l4\+\_\+proto' predicate. 

Predicates are used in conditional expressions, while monadic functions are combined with Kleisli operator\+:

l4\+\_\+proto(89) $>$$>$ log\+\_\+msg(\char`\"{}\+O\+S\+F\+P packet!\char`\"{}) \hypertarget{namespacepfq_1_1lang_1_1anonymous__namespace_02default_8hpp_03_ac16d4c4b496e6e882901d84ded462101}{\index{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}@{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}}!log\+\_\+buff@{log\+\_\+buff}}
...
Evaluate to /\+Pass Sk\+Buff/ if it is not a fragment, /\+Drop/ it otherwise. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is not a fragment or if it's the first fragment, /\+Drop/ it otherwise. 
...
Monadic version of 'has\+\_\+port' predicate. 

Predicates are used in conditional expressions, while monadic functions are combined with Kleisli operator\+:

port(80) $>$$>$ log\+\_\+msg (\char`\"{}http packet!\char`\"{}) \hypertarget{namespacepfq_1_1lang_1_1anonymous__namespace_02default_8hpp_03_aa8ac230fe8eeb0bccee8e31ba032cb8e}{\index{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}@{pfq\+::lang\+::anonymous\+\_\+namespace\lcurly{}default.\+hpp\rcurly{}}!rtp@{rtp}}
...
Evaluate to /\+Pass Sk\+Buff/ if it is a R\+T\+P/\+R\+T\+C\+P packet, /\+Drop/ it otherwise. 
...
Monadic version of 'has\+\_\+src\+\_\+port' predicate. 
...
Evaluate to /\+Pass Sk\+Buff/, or forward the packet to the given device. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is a T\+C\+P packet, /\+Drop/ it otherwise. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is a T\+C\+P packet (on top of I\+Pv6), /\+Drop/ it otherwise. 
...
It evaluates to /\+Pass Sk\+Buff/ or /\+Drop/, depending on the value returned by the predicate. Example\+:
...
Evaluate to /\+Pass Sk\+Buff/ if it is an U\+D\+P packet, /\+Drop/ it otherwise. 
...
Evaluate to /\+Pass Sk\+Buff/ if it is an U\+D\+P packet (on top of I\+Pv6), /\+Drop/ it otherwise. 
...
Evaluate to /\+Pass Sk\+Buff/ if it has a vlan tag, /\+Drop/ it otherwise. 
...
\hyperlink{structpfq_1_1lang_1_1Predicate}{Predicate} which evaluates to /\+True/ when the packet has one of the. 
...
Monadic function, counterpart of 'vlan\+\_\+id' function. 
...
The function takes a predicate and evaluates to given the Net\+Function when it evalutes to /\+True/, otherwise does nothing. Example\+:
