...
\item 
bool \hyperlink{classpfq_1_1socket_a736fac07a067a852e13f7c31362b6adb}{send\+\_\+raw} (\hyperlink{namespacepfq_ac835a1bd09b4cbaba61c100b50d0a99f}{const\+\_\+buffer} pkt, int \hyperlink{namespacepfq_a251ac5cc269aa123009754edf62ab8b4}{ifindex}, int qindex, uint64\+\_\+t nsec, size\+\_\+t fhint, unsigned int copies, bool async=false, int queue=any\+\_\+queue)
\begin{DoxyCompactList}\small\item\em Schedule a packet transmission. \end{DoxyCompactList}\item 
void \hyperlink{classpfq_1_1socket_add3ae894be6b7ab0e83f26bf290c5467}{tx\+\_\+queue} (int queue=0)
...
The first argument is the group id. The second argument is the name of the device; the third argument is the queue number or 'any\+\_\+queue'. \hypertarget{classpfq_1_1socket_a177de236ffec9f988df80b5c1725ba96}{\index{pfq\+::socket@{pfq\+::socket}!bind\+\_\+tx@{bind\+\_\+tx}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a177de236ffec9f988df80b5c1725ba96}


Bind the socket for transmission to the given device name and queue. 

The tid parameter specifies the index (id) of the transmitter thread. If 'no\+\_\+kthread' specified, bind refers to synchronous transmissions. \hypertarget{classpfq_1_1socket_ab68dbba5ef01041b9c96758c4a9f0a6c}{\index{pfq\+::socket@{pfq\+::socket}!caplen@{caplen}}
...
\hypertarget{classpfq_1_1socket_a2d80378cecae811bedc0ae8ff9412e62}{\index{pfq\+::socket@{pfq\+::socket}!send@{send}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a2d80378cecae811bedc0ae8ff9412e62}


Store the packet and transmit the packets in the queue. 

The queue is flushed every fhint packets. Requires the socket is bound for transmission to a net device and queue. See 'bind\+\_\+tx'. \hypertarget{classpfq_1_1socket_a16f84967f992ee861e5f18d5e29a3275}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+async@{send\+\_\+async}}
...
\item[{unsigned int}]{copies = {\ttfamily 1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a16f84967f992ee861e5f18d5e29a3275}


Transmit the packet asynchronously. 

The transmission is handled by P\+F\+Q kernel threads. Requires the socket is bound for transmission to one (or multiple) P\+F\+Q kernel threads. See 'bind\+\_\+tx'. \hypertarget{classpfq_1_1socket_a730cae7c25a32b22cc79615cbf3f86aa}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+at@{send\+\_\+at}}
...
\item[{int}]{queue = {\ttfamily any\+\_\+queue}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a736fac07a067a852e13f7c31362b6adb}


Schedule a packet transmission. 

The packet is copied into a Tx queue. If 'async' is true and 'queue' is set to any\+\_\+queue, a T\+S\+S symmetric hash function is used to select the Tx queue. The packet is transmitted at the given timestamp by a P\+F\+Q kernel thread. Otherwise the queue is flushed every 'fhint' packets. A timestamp of 0 nanoseconds means immediate transmission. \hypertarget{classpfq_1_1socket_a3fddba43aa4da1f30fc04cdc3556054a}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+to@{send\+\_\+to}}
\index{send\+\_\+to@{send\+\_\+to}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{send\+\_\+to}]{\setlength{\rightskip}{0pt plus 5cm}bool pfq\+::socket\+::send\+\_\+to (
\begin{DoxyParamCaption}
\item[{{\bf const\+\_\+buffer}}]{pkt, }
\item[{int}]{ifindex, }
\item[{int}]{qindex, }
...
\item[{unsigned int}]{copies = {\ttfamily 1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a3fddba43aa4da1f30fc04cdc3556054a}


Store the packet and transmit the packets in the queue. 

The queue is flushed every fhint packets. \hypertarget{classpfq_1_1socket_a5cb37765ffcb1b78c5d61211f9e806df}{\index{pfq\+::socket@{pfq\+::socket}!set\+\_\+group\+\_\+computation@{set\+\_\+group\+\_\+computation}}
...
\hypertarget{classpfq_1_1socket_add3ae894be6b7ab0e83f26bf290c5467}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+queue@{tx\+\_\+queue}}
\index{tx\+\_\+queue@{tx\+\_\+queue}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{tx\+\_\+queue}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::tx\+\_\+queue (
\begin{DoxyParamCaption}
\item[{int}]{queue = {\ttfamily 0}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_add3ae894be6b7ab0e83f26bf290c5467}


Transmit the packets in the queue. 

Transmit the packets in the queue of the socket. 'queue = 0' is the queue of the socket enabled for synchronous transmission. \hypertarget{classpfq_1_1socket_a019d15a072c043d6a1333ca0c836da4c}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+slots@{tx\+\_\+slots}}
