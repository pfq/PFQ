...
\item 
bool \hyperlink{classpfq_1_1socket_aee365a7044043d08507adba75eb290c6}{send\+\_\+deferred} (\hyperlink{namespacepfq_ac835a1bd09b4cbaba61c100b50d0a99f}{const\+\_\+buffer} buf, uint64\+\_\+t nsec, int copies, int queue=any\+\_\+queue)
\begin{DoxyCompactList}\small\item\em Schedule packet transmission. \end{DoxyCompactList}\item 
void \hyperlink{classpfq_1_1socket_a88e4764d8e7fc86b6e3ea1fbff407a96}{tx\+\_\+queue\+\_\+flush} (int queue=any\+\_\+queue)
\begin{DoxyCompactList}\small\item\em Flush the Tx queue(s). \end{DoxyCompactList}\item 
void \hyperlink{classpfq_1_1socket_a60613b9eec686a179332e0a86d1ea954}{tx\+\_\+async\+\_\+start} ()
\begin{DoxyCompactList}\small\item\em Start kernel threads. \end{DoxyCompactList}\item 
void \hyperlink{classpfq_1_1socket_ad96bd5f41036291082fc0eaac0fec4d5}{tx\+\_\+async\+\_\+stop} ()
\begin{DoxyCompactList}\small\item\em Stop kernel threads. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\hypertarget{classpfq_1_1socket_ad0e09474a9919723dfdf142e2b1e5386}{\index{pfq\+::socket@{pfq\+::socket}!socket@{socket}}
\index{socket@{socket}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{socket}]{\setlength{\rightskip}{0pt plus 5cm}pfq\+::socket\+::socket (
\begin{DoxyParamCaption}
...
\item[{size\+\_\+t}]{tx\+\_\+slots = {\ttfamily 1024}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a419985e445525a7dbfae6d9ace452427}


Constructor. 

Create a socket with the given group policy. The default class used is \hyperlink{namespacepfq_a96af1f5ed530eff563eb917516758fbba172b03053216c6158fe380805998ad6c}{class\+\_\+mask\+::default\+\_\+}. \hypertarget{classpfq_1_1socket_abad0a4046d6af6c5b0b9b9759af6ff0a}{\index{pfq\+::socket@{pfq\+::socket}!socket@{socket}}
\index{socket@{socket}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{socket}]{\setlength{\rightskip}{0pt plus 5cm}pfq\+::socket\+::socket (
\begin{DoxyParamCaption}
...
\item[{size\+\_\+t}]{tx\+\_\+slots = {\ttfamily 1024}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_abad0a4046d6af6c5b0b9b9759af6ff0a}


Constructor. 

Create a socket with the given class mask and group policy. All the possible parameters are specifiable. \hypertarget{classpfq_1_1socket_a08fbdcc1736de36d205282ce20ffbaa3}{\index{pfq\+::socket@{pfq\+::socket}!````~socket@{$\sim$socket}}
...
The first argument is the name of the device; the second argument is the queue index or 'any\+\_\+queue'. \hypertarget{classpfq_1_1socket_a4d4d44cc68af0290e3c494dcd10b1541}{\index{pfq\+::socket@{pfq\+::socket}!bind\+\_\+group@{bind\+\_\+group}}
...
The first argument is the group id. The second argument is the name of the device; the third argument is the queue number or 'any\+\_\+queue'. \hypertarget{classpfq_1_1socket_ae1a9ad5e1d5ad478a1a642f29f49e9c0}{\index{pfq\+::socket@{pfq\+::socket}!bind\+\_\+tx@{bind\+\_\+tx}}
...
\item[{const char $\ast$}]{dev, }
\item[{int}]{queue = {\ttfamily any\+\_\+queue}, }
\item[{int}]{core = {\ttfamily no\+\_\+kthread}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_ae1a9ad5e1d5ad478a1a642f29f49e9c0}


Bind the socket for transmission to the given device name and queue. 

The core parameter specifies the C\+P\+U index where to run a kernel thread (unless 'no\+\_\+kthread' id specified). \hypertarget{classpfq_1_1socket_ab68dbba5ef01041b9c96758c4a9f0a6c}{\index{pfq\+::socket@{pfq\+::socket}!caplen@{caplen}}
...
Capture length must be set before the socket is enabled. \hypertarget{classpfq_1_1socket_a768bee4d974acdc5ee9ee879b0903c54}{\index{pfq\+::socket@{pfq\+::socket}!caplen@{caplen}}
\index{caplen@{caplen}!pfq\+::socket@{pfq\+::socket}}
...
Release the shared memory, stop kernel threads. \hypertarget{classpfq_1_1socket_aba44de6422e3e10b65474e7f3999ebd0}{\index{pfq\+::socket@{pfq\+::socket}!current\+\_\+commit@{current\+\_\+commit}}
...
Release the shared memory, stop kernel threads. \hypertarget{classpfq_1_1socket_ae6cd08be2e7c35a548a64fded4359612}{\index{pfq\+::socket@{pfq\+::socket}!dispatch@{dispatch}}
...
typedef void ($\ast$pfq\+\_\+handler)(char $\ast$user, const struct pfq\+\_\+pkthdr $\ast$h, const char $\ast$data); \hypertarget{classpfq_1_1socket_a2c96741054ea764f5d8c31295ef5df29}{\index{pfq\+::socket@{pfq\+::socket}!egress\+\_\+bind@{egress\+\_\+bind}}
...
The egress socket is be used by groups as network forwarder. \hypertarget{classpfq_1_1socket_ae80718e8f26cdaed3fd05bfde6d835e0}{\index{pfq\+::socket@{pfq\+::socket}!egress\+\_\+unbind@{egress\+\_\+unbind}}
...
Each socket can bind to multiple groups. Each bit set in the mask represents a joined group. \hypertarget{classpfq_1_1socket_af3f79e9a42964907acd581d35d42da00}{\index{pfq\+::socket@{pfq\+::socket}!id@{id}}
...
\hypertarget{classpfq_1_1socket_a0a80909f34ab601e4c96ee8cb28a3230}{\index{pfq\+::socket@{pfq\+::socket}!is\+\_\+enabled@{is\+\_\+enabled}}
\index{is\+\_\+enabled@{is\+\_\+enabled}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{is\+\_\+enabled}]{\setlength{\rightskip}{0pt plus 5cm}bool pfq\+::socket\+::is\+\_\+enabled (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a0a80909f34ab601e4c96ee8cb28a3230}


Check whether the socket capture is enabled. 

\hypertarget{classpfq_1_1socket_a903d76a2685d7b64b9d0604686141fdc}{\index{pfq\+::socket@{pfq\+::socket}!is\+\_\+timestamping\+\_\+enabled@{is\+\_\+timestamping\+\_\+enabled}}
\index{is\+\_\+timestamping\+\_\+enabled@{is\+\_\+timestamping\+\_\+enabled}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{is\+\_\+timestamping\+\_\+enabled}]{\setlength{\rightskip}{0pt plus 5cm}bool pfq\+::socket\+::is\+\_\+timestamping\+\_\+enabled (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a903d76a2685d7b64b9d0604686141fdc}


Check whether timestamping for packets is enabled. 

\hypertarget{classpfq_1_1socket_afbd75341794fae964ed23ce5858fd153}{\index{pfq\+::socket@{pfq\+::socket}!join\+\_\+group@{join\+\_\+group}}
...
If the policy is not specified, \hyperlink{namespacepfq_ac41249c8510558905b01fa4d866a38d7a9e81e7b963c71363e2fb3eefcfecfc0e}{group\+\_\+policy\+::shared} is used by default. If the class mask is not specified, \hyperlink{namespacepfq_a96af1f5ed530eff563eb917516758fbba172b03053216c6158fe380805998ad6c}{class\+\_\+mask\+::default\+\_\+} is used by default. \hypertarget{classpfq_1_1socket_ac512d6b89db52da73a51ba9112658180}{\index{pfq\+::socket@{pfq\+::socket}!leave\+\_\+group@{leave\+\_\+group}}
...
\hypertarget{classpfq_1_1socket_a432ea40ac382d251b105e3d5987b9b4a}{\index{pfq\+::socket@{pfq\+::socket}!open@{open}}
...
\item[{size\+\_\+t}]{tx\+\_\+slots = {\ttfamily 1024}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a432ea40ac382d251b105e3d5987b9b4a}


Open the socket with the given group policy. 

If the policy is not \hyperlink{namespacepfq_ac41249c8510558905b01fa4d866a38d7a5e543256c480ac577d30f76f9120eb74}{group\+\_\+policy\+::undefined}, also join a new group with \hyperlink{namespacepfq_a96af1f5ed530eff563eb917516758fbba172b03053216c6158fe380805998ad6c}{class\+\_\+mask\+::default\+\_\+} and the given policy. \hypertarget{classpfq_1_1socket_ab86880ccdfdd9f875e376c6c8d22a2bb}{\index{pfq\+::socket@{pfq\+::socket}!open@{open}}
\index{open@{open}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{open}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::open (
\begin{DoxyParamCaption}
\item[{{\bf class\+\_\+mask}}]{mask, }
...
\item[{size\+\_\+t}]{tx\+\_\+slots = {\ttfamily 1024}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_ab86880ccdfdd9f875e376c6c8d22a2bb}
...
Unspecified parameters are set to default values as in \hyperlink{namespacepfq_1_1param_af1fd1aeb980688527db587b35f55abf2}{param\+::make\+\_\+default()}; \hypertarget{classpfq_1_1socket_a3cfd9674358a2ffd8b37e76d73b8a654}{\index{pfq\+::socket@{pfq\+::socket}!operator=@{operator=}}
...
P\+F\+Q socket is not copy-\/assignable. 
...
Wait for packets available for reading. A timeout in microseconds can be specified. \hypertarget{classpfq_1_1socket_a6004249d3abfe8a2329b44ba797d1909}{\index{pfq\+::socket@{pfq\+::socket}!read@{read}}
\index{read@{read}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{read}]{\setlength{\rightskip}{0pt plus 5cm}{\bf net\+\_\+queue} pfq\+::socket\+::read (
\begin{DoxyParamCaption}
\item[{long int}]{microseconds = {\ttfamily -\/1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a6004249d3abfe8a2329b44ba797d1909}


Read packets in place. 

Wait for packets and return a 'queue' descriptor, which contains the references to packets.

The memory of the socket queue is reset at the next read. A timeout is specified in microseconds. \hypertarget{classpfq_1_1socket_a57643b9011269682bf716254c2b72907}{\index{pfq\+::socket@{pfq\+::socket}!recv@{recv}}
\index{recv@{recv}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{recv}]{\setlength{\rightskip}{0pt plus 5cm}{\bf net\+\_\+queue} pfq\+::socket\+::recv (
\begin{DoxyParamCaption}
\item[{const {\bf mutable\+\_\+buffer} \&}]{buff, }
\item[{long int}]{microseconds = {\ttfamily -\/1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a57643b9011269682bf716254c2b72907}
...
Packets are stored in the given buffer. It is possible to specify a timeout in microseconds. \hypertarget{classpfq_1_1socket_a2327e71a6f94e54efb0da5ec36b1c620}{\index{pfq\+::socket@{pfq\+::socket}!reset\+\_\+group\+\_\+fprog@{reset\+\_\+group\+\_\+fprog}}
...
\hypertarget{classpfq_1_1socket_a0f2205329249eaa7a6229980a744fd2a}{\index{pfq\+::socket@{pfq\+::socket}!rx\+\_\+slots@{rx\+\_\+slots}}
\index{rx\+\_\+slots@{rx\+\_\+slots}!pfq\+::socket@{pfq\+::socket}}
...
\hypertarget{classpfq_1_1socket_a3c6476cbd81ea906fdbd256c50eba059}{\index{pfq\+::socket@{pfq\+::socket}!send@{send}}
...
\item[{int}]{copies = {\ttfamily 1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a3c6476cbd81ea906fdbd256c50eba059}


Store the packet and transmit the packets in the queue. 

The queue is flushed (if required) and the transmission takes place. \hypertarget{classpfq_1_1socket_a7a1d64344f0c476117d5b7cc2543edad}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+async@{send\+\_\+async}}
...
\item[{int}]{copies = {\ttfamily 1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a7a1d64344f0c476117d5b7cc2543edad}


Store the packet and transmit the packets in the queue, asynchronously. 

The transmission is invoked every  packets. When T\+X kernel threads are in use,  is ignored. \hypertarget{classpfq_1_1socket_a7511ca4657999e1c158859d34cffc831}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+at@{send\+\_\+at}}
\index{send\+\_\+at@{send\+\_\+at}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{send\+\_\+at}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Clock , typename Duration $>$ bool pfq\+::socket\+::send\+\_\+at (
\begin{DoxyParamCaption}
\item[{{\bf const\+\_\+buffer}}]{pkt, }
\item[{std\+::chrono\+::time\+\_\+point$<$ Clock, Duration $>$ const \&}]{tp, }
\item[{int}]{copies = {\ttfamily 1}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a7511ca4657999e1c158859d34cffc831}
Store the packet and transmit it.

The transmission takes place asynchronously at the given timespec time, specified as a generic chrono\+::time\+\_\+point. \hypertarget{classpfq_1_1socket_aee365a7044043d08507adba75eb290c6}{\index{pfq\+::socket@{pfq\+::socket}!send\+\_\+deferred@{send\+\_\+deferred}}
\index{send\+\_\+deferred@{send\+\_\+deferred}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{send\+\_\+deferred}]{\setlength{\rightskip}{0pt plus 5cm}bool pfq\+::socket\+::send\+\_\+deferred (
\begin{DoxyParamCaption}
...
\item[{int}]{queue = {\ttfamily any\+\_\+queue}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_aee365a7044043d08507adba75eb290c6}


Schedule packet transmission. 

The packet is copied into a Tx queue (using a T\+S\+S symmetric hash if any\+\_\+queue is specified) and transmitted at the given timestamp by a kernel thread or when tx\+\_\+queue\+\_\+flush is called. A timestamp of 0 nanoseconds means 'immediate transmission. \hypertarget{classpfq_1_1socket_a5cb37765ffcb1b78c5d61211f9e806df}{\index{pfq\+::socket@{pfq\+::socket}!set\+\_\+group\+\_\+computation@{set\+\_\+group\+\_\+computation}}
...
The functional computation is specified as a P\+F\+Q/lang expression. \hypertarget{classpfq_1_1socket_acd2ef781a82b49566f03a085ba091138}{\index{pfq\+::socket@{pfq\+::socket}!set\+\_\+group\+\_\+computation@{set\+\_\+group\+\_\+computation}}
\index{set\+\_\+group\+\_\+computation@{set\+\_\+group\+\_\+computation}!pfq\+::socket@{pfq\+::socket}}
...
This ability is limited to simple P\+F\+Q/lang functional computations. Only the composition of monadic functions without arguments are currently supported. \hypertarget{classpfq_1_1socket_ad618894910a12a08eaed3d8668db25af}{\index{pfq\+::socket@{pfq\+::socket}!set\+\_\+group\+\_\+fprog@{set\+\_\+group\+\_\+fprog}}
...
This function can be used to set a specific B\+P\+F filter for the group. It is used by the P\+F\+Q/pcap library. \hypertarget{classpfq_1_1socket_a0a0a637d733613bf86d6d85168d2e37f}{\index{pfq\+::socket@{pfq\+::socket}!stats@{stats}}
...
\hypertarget{classpfq_1_1socket_a39457556d11f22b1266abc8f9f7c46bd}{\index{pfq\+::socket@{pfq\+::socket}!timestamping\+\_\+enable@{timestamping\+\_\+enable}}
\index{timestamping\+\_\+enable@{timestamping\+\_\+enable}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{timestamping\+\_\+enable}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::timestamping\+\_\+enable (
\begin{DoxyParamCaption}
\item[{bool}]{value}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a39457556d11f22b1266abc8f9f7c46bd}


Enable/disable timestamping for packets. 

\hypertarget{classpfq_1_1socket_a60613b9eec686a179332e0a86d1ea954}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+async\+\_\+start@{tx\+\_\+async\+\_\+start}}
\index{tx\+\_\+async\+\_\+start@{tx\+\_\+async\+\_\+start}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{tx\+\_\+async\+\_\+start}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::tx\+\_\+async\+\_\+start (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a60613b9eec686a179332e0a86d1ea954}


Start kernel threads. 

Start kernel threads associated with the Tx queues of the socket. \hypertarget{classpfq_1_1socket_ad96bd5f41036291082fc0eaac0fec4d5}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+async\+\_\+stop@{tx\+\_\+async\+\_\+stop}}
\index{tx\+\_\+async\+\_\+stop@{tx\+\_\+async\+\_\+stop}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{tx\+\_\+async\+\_\+stop}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::tx\+\_\+async\+\_\+stop (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_ad96bd5f41036291082fc0eaac0fec4d5}


Stop kernel threads. 

Stop kernel threads associated with the Tx queues of the socket. \hypertarget{classpfq_1_1socket_a88e4764d8e7fc86b6e3ea1fbff407a96}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+queue\+\_\+flush@{tx\+\_\+queue\+\_\+flush}}
...
\item[{int}]{queue = {\ttfamily any\+\_\+queue}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a88e4764d8e7fc86b6e3ea1fbff407a96}


Flush the Tx queue(s). 

Transmit the packets in the Tx queues of the socket. \hypertarget{classpfq_1_1socket_a019d15a072c043d6a1333ca0c836da4c}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+slots@{tx\+\_\+slots}}
...
\hypertarget{classpfq_1_1socket_a11b91a39fdae65cace365aa3583eba7d}{\index{pfq\+::socket@{pfq\+::socket}!tx\+\_\+slots@{tx\+\_\+slots}}
\index{tx\+\_\+slots@{tx\+\_\+slots}!pfq\+::socket@{pfq\+::socket}}
...
\hypertarget{classpfq_1_1socket_a99ee5e145ccf3a043b3c2aacb3df30cc}{\index{pfq\+::socket@{pfq\+::socket}!unbind\+\_\+tx@{unbind\+\_\+tx}}
\index{unbind\+\_\+tx@{unbind\+\_\+tx}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{unbind\+\_\+tx}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::unbind\+\_\+tx (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a99ee5e145ccf3a043b3c2aacb3df30cc}


Unbind the socket transmission. 

Unbind the socket for transmission from any device/queue. \hypertarget{classpfq_1_1socket_aaf91b2e089edb2c4695584b01774326e}{\index{pfq\+::socket@{pfq\+::socket}!vlan\+\_\+filters\+\_\+enable@{vlan\+\_\+filters\+\_\+enable}}
...
\hypertarget{classpfq_1_1socket_ad843f3354b92083f01be9b5055f211b8}{\index{pfq\+::socket@{pfq\+::socket}!weight@{weight}}
\index{weight@{weight}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{weight}]{\setlength{\rightskip}{0pt plus 5cm}void pfq\+::socket\+::weight (
\begin{DoxyParamCaption}
\item[{int}]{w}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_ad843f3354b92083f01be9b5055f211b8}


Set the weight of the socket for the steering phase. 

\hypertarget{classpfq_1_1socket_a424e7a361a31569a8c6796d2c61b238d}{\index{pfq\+::socket@{pfq\+::socket}!weight@{weight}}
\index{weight@{weight}!pfq\+::socket@{pfq\+::socket}}
\subsubsection[{weight}]{\setlength{\rightskip}{0pt plus 5cm}int pfq\+::socket\+::weight (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{classpfq_1_1socket_a424e7a361a31569a8c6796d2c61b238d}
